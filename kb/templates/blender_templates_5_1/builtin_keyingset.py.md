...
blender_version: 5.1
tags: [objects, operators, keying-set, animation, viewport-menu]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [operators, custom-geometry, viewport-menu, object-creation, keying-set]
last_updated: 2026-04-29
search_keywords: [keying set, KeyingSetInfo, animation properties, bpy.types.KeyingSetInfo, register, unregister, property paths, location, layers, show_in_front, custom geometry]
---

# Template - Built-in Keying Set
