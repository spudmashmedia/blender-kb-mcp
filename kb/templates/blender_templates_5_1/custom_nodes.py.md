...
blender_version: 5.1
tags: [nodes, node-editor, custom-nodes, bpy.types.NodeTree, bpy.props]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [node-editors, custom-geometry, add-ons, editor-extensions]
last_updated: 2026-04-29
search_keywords: [custom node tree, node socket, bpy.types.NodeTree, bpy.types.Node, NODE_MT_add, NODE_MT_swap, register, unregister, custom properties, node interface]
---
