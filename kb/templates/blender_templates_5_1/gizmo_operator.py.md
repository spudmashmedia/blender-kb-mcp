...
blender_version: 5.1
tags: [operators, gizmos, mesh, viewport-menu, custom-geometry]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [operators, custom-gizmos, viewport-menu, vertex-selection]
last_updated: 2026-04-29
search_keywords: [select vertices, plane selection, gizmo operator, FloatVectorProperty, bpy.types.Operator, GIZMO_GT_move_3d, GIZMO_GT_dial_3d, EDIT_MESH mode, register, unregister]
---

# Template - Gizmo Operator
