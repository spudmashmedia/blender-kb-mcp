...
blender_version: 5.1
tags: [gizmo, viewport-menu, operators, object-manipulation, custom-tools]
related_files: [02_object_properties.py.md, 07_gizmo_groups/01_translate_widget.py.md]
difficulty: beginner
categories: [operators, custom-geometry, viewport-menu, gizmos]
last_updated: 2026-04-29
search_keywords: [gizmo group, translate operator, VIEW_3D gizmo, transform.translate, GizmoGroup, custom widget, object manipulation, register, unregister, bl_space_type]
---

# Template - Gizmo Simple 2D
