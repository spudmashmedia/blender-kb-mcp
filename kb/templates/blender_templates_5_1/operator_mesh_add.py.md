...
blender_version: 5.1
tags: [operators, custom-mesh, viewport-menu, object-properties]
...
search_keywords: [add mesh box, custom primitive operator, float property size, bmesh mesh creation, VIEW3D_MT_mesh_add menu, AddObjectHelper, register unregister pattern, bpy.types.Operator]
---

# Template - Operator Mesh Add
