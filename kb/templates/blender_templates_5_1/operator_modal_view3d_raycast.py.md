...
blender_version: 5.1
tags: [operators, viewport-menu, ray-cast, modal-operators, object-selection]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [operators, custom-geometry, viewport-menu, object-selection, modal-operators]
last_updated: 2026-04-29
search_keywords: [ray cast, modal operator, viewport selection, bpy.types.Operator, VIEW3D_MT_view, region_2d_to_vector_3d, ray_cast, select_set, context.region_data]
---

# Template - Operator Modal View 3D Raycast
