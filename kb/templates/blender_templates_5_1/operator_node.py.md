...
blender_version: 5.1
tags: [node-editor, operators, bpy.types.Operator, VIEW3D_MT_node, custom-geometry]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: beginner
categories: [operators, node-editors, viewport-menu, object-creation]
last_updated: 2026-04-29
search_keywords: [node operator, link nodes, bpy.types.Operator, NODE_MT_node, node editor context, socket connection, execute method, poll method, register unregister]
---
