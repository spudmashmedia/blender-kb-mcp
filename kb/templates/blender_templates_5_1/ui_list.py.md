...
blender_version: 5.1
tags: [objects, operators, mesh, viewport-menu, ui-list]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [operators, custom-ui, viewport-menu, object-properties]
last_updated: 2026-04-29
search_keywords: [UIList, MESH_UL_mylist, draw_item, draw_filter, filter_items, bitflag_filter_item, bpy.types.UIList, vertex groups, list filtering, property drawing, register, unregister]
---
