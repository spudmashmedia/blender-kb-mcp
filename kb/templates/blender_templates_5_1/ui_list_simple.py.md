...
search_keywords: [create object, mesh add_object, operator, custom geometry, scale property, bpy.types.Operator, VIEW3D_MT_mesh_add, floatvectorproperty, register, unregister, bpy.types.UIList, template_list, draw_item, material_slots, active_material_index, PROPERTIES, WINDOW, bl_label, bl_idname]
---

# Template - UI List Simple
