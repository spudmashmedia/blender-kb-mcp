...
blender_version: 5.1
tags: [icons, ui-previews, preview-collections, bpy.utils.previews, panel, operators]
related_files: [02_object_properties.py.md, 08_error_handling_patterns/01_safe_operations.py.md, ui_previews_dynamic_enum.py.md]
difficulty: beginner
categories: [custom-ui, viewport-menu, object-creation, addon-development]
last_updated: 2026-04-29
search_keywords: [custom icon, preview collections, bpy.utils.previews, Panel, operator, icon_value, register, unregister, addon portability, relative path, thumbnail IMAGE, UILayout button]
---

# Template - UI Previews Custom Icons
