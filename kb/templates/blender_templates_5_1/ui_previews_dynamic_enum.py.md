...
blender_version: 5.1
tags: [enum-properties, custom-icons, previews, properties-panel, addon-development]
related_files: [02_object_properties.py.md, ui_previews_custom_icon.py.md, 08_error_handling_patterns/01_safe_operations.py.md]
difficulty: intermediate
categories: [ui-customization, addon-development, properties-panel, icon-system]
last_updated: 2026-04-29
search_keywords: [EnumProperty callback, custom icons, bpy.utils.previews, WindowManager properties, panel drawing, dynamic enum population, image thumbnails, register unregister, OBJECT_PT_previews, template_icon_view]
---

# Template - UI Previews Dynamic Enum
